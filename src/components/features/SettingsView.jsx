    ...
    return (<div className="h-full overflow-auto p-6 max-w-xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-3 gap-2">
          {cards.map((card, i) => (<motion.div key={card.label} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.06 }} className="rounded-xl border border-border bg-card p-4 text-center">
