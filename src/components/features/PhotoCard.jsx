/**
 * Photo card — Apple Photos inspired with refined hover & keyboard accessibility.
 * Uses forwardRef to support virtualized grid parent.
 */
...
export const PhotoCard = memo(
    forwardRef(function PhotoCard({ image, isSelected, onSelect, style }, ref) {
        ...
        return (
            <motion.div
                ...
                className="relative cursor-pointer overflow-hidden rounded-[6px] bg-card group focus:outline-none focus:ring-2 focus:ring-primary"
